...
// MARK: - ChampOriginValue
class ChampClass: Codable {
    let key, name: String
    let champOriginDescription: String?
    let accentChampionImage: String?
    let bonuses: [Bonus]
    
    enum CodingKeys: String, CodingKey {
        case key, name
        case champOriginDescription = "description"
        case accentChampionImage, bonuses
    }
    
    init(key: String, name: String, champOriginDescription: String?, accentChampionImage: String?, bonuses: [Bonus]) {
        self.key = key
        self.name = name
        self.champOriginDescription = champOriginDescription
        self.accentChampionImage = accentChampionImage
        self.bonuses = bonuses
    }
}
...
typealias ChampOrigin = [String: ChampClass]
